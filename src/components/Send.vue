<template>
  <b-card class="border-0">
    <b-form @submit="onSubmit" @reset="resetForm" v-if="show">
      <b-form-group id="input-group-1" label-for="input-1" label="Sending To">
      ...
      <div class="qr-code-reader modal" v-show="showQrCodeReader">
        ...
        >
          <div
            ...
            "
          >
            <button class="close-btn" v-on:click="closeScanner()">
              &#10006;
            </button>
          </div>
        </div>
